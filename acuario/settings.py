"""
Django settings for acuario project.
...
SECRET_KEY = 'django-insecure-847hy)p%_%1w-0no=w-wco5rpt9nno4@g#!714oel#kjol24c!'
...
WSGI_APPLICATION = 'acuario.wsgi.application'
